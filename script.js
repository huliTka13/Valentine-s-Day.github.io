...
let attempts = 0;
const catPhrases = ['Когда я так к тебе обратился – это шокировало нас обоих','Когда я так к тебе обратился – это шокировало нас обоих', 'Я к тебе так обратился, когда мы сидели за барной стойкой в трукост','Я к тебе так обратился, когда мы сидели за барной стойкой в трукост', 'Я расстроен... ', 'Я расстроен... ', 'Давай помогу с началом слова: любима...','Давай помогу с началом слова: любима...'];
let photoClicks = 0;
